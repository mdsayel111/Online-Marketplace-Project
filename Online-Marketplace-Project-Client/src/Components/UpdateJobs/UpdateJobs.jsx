...
const UpdateJobs = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["job"],
    queryFn: async () => {
      const data = await axios.get(`/job/${id}?userEmail=${user.email}`);
  ...
  const { mutateAsync } = useMutation({
    mutationKey: ["job"],
    mutationFn: async (data) => axios.put(`/job/${id}?userEmail=${user.email}`, data),
    onSuccess: () => {
