...
const UserTestimonials = () => {
  return (
    <div class="container my-8 mx-auto md:p-6 bg-secondary">
      <section class="mb- text-center">
        <h2 class="mb-6 pb-4 text-center text-3xl font-bold text-white">User Testimonials</h2>

        <div class="grid gap-6 md:grid-cols-3 xl:gap-x-12">
          <div class="mb-6 lg:mb-0">
            <div class="relative block rounded-lg bg-pink-500 text-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
              <div class="flex">
                <div
