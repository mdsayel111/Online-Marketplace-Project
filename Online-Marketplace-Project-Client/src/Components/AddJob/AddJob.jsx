...
const AddJob = () => {
  ...
  const handleAddJob = async (e) => {
    ...
    if(Deadline < new Date().getTime() || !Deadline){
     return toast.error("Deadline is invslid")
    }
    const result = await axios.post(`/add-job?userEmail=${user.email}`, jobDetails)
  ...
  return (
    <div className=" flex flex-row items-center mx-auto w-fit my-8">
      <Helmet>
        <title>O.M.P | Add Job</title>
        ...
        >
          <div className="mb-4 flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <div className="relative day-picker h-11 w-full">
                <DatePicker
