...
export function BidsRequest() {
  ...
  const { data, isLoading, refetch, isError } = useQuery({
    queryKey: ["bids-req", sort, filter],
    queryFn: async () => {
      console.log("fetch");
      const res = await axios.get(
        `/bids/req/?userEmail=${user.email}&sort=${sort}&filter=${filter}`
      );
      const data = res.data;
      return data;
    },
  ...
  return (
    <>
      <Helmet>
        <title>O.M.P | Bids Request</title>
                  ...
                  <thead>
                    <tr>
                      ...
                      >
                        ...
                        >
                          <span className="text-center">Bidding Price</span>
                        </Typography>
                      </th>
                      <th
                        // key={}
